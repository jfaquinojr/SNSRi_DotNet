...
Public Class HSPI
    ...
    Dim _hub As IEventsHub

    Public Sub New()
        Console.WriteLine("Creating EventsHub")
        _hub = EventsHub.CreateInstance(Utility.GetConfigValue("SNSRi.API.URL", "http://localhost:2410"))
        Console.WriteLine("EventsHub Created")
    End Sub

    Public Sub New(hub As IEventsHub)
        _hub = hub
    End Sub
